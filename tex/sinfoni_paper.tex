...
The data from each OB was reduced separately using the standard SINFONI EsoRex pipeline. The output of EsoRex is a bias and flat-corrected, sky-subtracted, wavelength-calibrated datacube. For flux calibration, we observed flux standard stars which were reduced using the same EsoRex pipeline. We wrote our own Python pipeline to flux-calibrate the science datacubes.\footnote{All our software is available at \url{https://github.com/SheffAGN/SINFONI_outflows}.} 
